...
// Things that depend on I/O and JavaScript-specific libraries (e.g. logging using JSON.stringify) should be implemented in eite-browser.js (or later, other eite-*.js files). Perhaps, for non-portable things shared betw
